...
Girouette routes work seamlessly with AdonisJS response handling:

### Return Values

Simply return data from your controller methods:
...
@Patch('/resources/:id', 'resources.patch') // Partial update
@Delete('/resources/:id', 'resources.destroy') // Delete
```

## Next Steps

- [Route Groups](/docs/route-groups) - Organize routes with prefixes and shared configuration
- [Middleware](/docs/middleware) - Protect your routes
