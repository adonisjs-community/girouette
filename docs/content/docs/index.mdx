...
<Cards>
  ...
  <Card title="Route Constraints" href="/constraints">
    Validate route parameters with regex or custom matchers
  </Card>
  <Card title="HMR Support" href="/hmr-support">
    Instant updates to route logic during development without server restarts
  </Card>
  <Card title="Controller Discovery" href="/controller-discovery">
...
- [Basic Routing](/basic-routing) - Learn the HTTP method decorators
