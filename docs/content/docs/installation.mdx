...
- [Basic Routing](/basic-routing) - Learn about HTTP method decorators
- [Route Groups](/route-groups) - Organize routes with groups
- [Resources](/resources) - Create RESTful resource controllers
